        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header with-border">
              <center><a href="#addnew" data-toggle="modal" class="btn btn-info btn-flat" id="addproduct"><i class="fa fa-plus"></i><b> CREATE NEW WORKER</b></a></center>
              <div class="pull-right">
                <form class="form-inline">
                  <div class="form-group">
                    <center><label>WORKER CATEGORY: </label></center>
                    <center><select class="form-control input-sm" id="select_category">
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered" style="background:#CCD1D1">
                <thead style="background:#ABEBC6">
                  <th><big><b><center>WORKER NAME</center></b></big></th>
				  <th><big><b></b></big></th>
                  <th><big><b><center>WORKER PHOTO</center></b></big></th>

                  <th><big><b><center>HOURLY PRICE</center></b></big></th>
                  ...
                  <?php
                    ...
                    try{
                      ...
                      foreach($stmt as $row){
                        ...
                        echo "
                          <tr>
                            <td><center><h4><b>".$row['name']."</b></h4></td></center>
							    <td><center><a href='#description' data-toggle='modal' class='btn btn-info btn-sm btn-flat desc' data-id='".$row['id']."'><i class='fa fa-'></i><b>DETAILS</b></a></center></td>
                            <td>
                            ...
                            <td><center>BDT - ".number_format($row['price'], 2)."</center></td>
                            <td>
