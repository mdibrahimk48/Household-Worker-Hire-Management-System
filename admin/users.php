...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <b>CUSTOMERS LIST OF THE SYSTEM</b>
      </h1>
      <ol class="breadcrumb">
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header with-border">
              <center><a href="#addnew" data-toggle="modal" class="btn btn-info btn-flat"><i class="fa fa-plus"></i><b> CREATE NEW USER</b></a></center>
            </div>
            <div class="box-body">
              <table id="example1" class="table table-bordered" style="background:#CCD1D1">
                <thead style="background:#ABEBC6">
				  <th><big><b>CUSTOMER NAME</b></big></th>
                  <th><big><b><center>EMAIL ADDRESS</center></b></big></th>
                  <th><big><b>CUSTOMER PHOTO</b></big></th>
                      ...
                      foreach($stmt as $row){
                        ...
                        echo "
                          <tr>
                            ...
                            <td>
                              <a href='cart.php?user=".$row['id']."' class='btn btn-info btn-sm btn-flat'><i class='fa fa-'></i><b>BASKETS</b></a>
                              <button class='btn btn-danger btn-sm delete btn-flat' data-id='".$row['id']."'><i class='fa fa-'></i><b> DELETE USER</b></button>
                            </td>
                          </tr>
                        ";
                      }
