  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">DELIVER WORKER</li>
      </ol>
    </section>
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered" style="background:#CCD1D1">
                <thead style="background:#ABEBC6">
                  <th class="hidden" ></th>
                  <th><big><big><b><center>DELIVERY DATE</center></b></big></big></th>
                  <th><big><big><b><center>CUSTOMER NAME</center></b></big></big></th>
                  <th><big><big><b><center>TRANSACTION ID.</center></b></big></big></th>
                      ...
                      foreach($stmt as $row){
                        ...
                        echo "
                          <tr>
                            ...
                            <td><center><button type='button' class='btn btn-info btn-sm btn-flat transact' data-id='".$row['salesid']."'><i class='fa fa-'></i> <b>DETAILS</b></button></center></td>
                          </tr>
                        ";
                      }
                    }
